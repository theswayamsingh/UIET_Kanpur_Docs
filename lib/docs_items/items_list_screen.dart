...
class _ItemsListScreenState extends State<ItemsListScreen> {
  ...
  loadFiles() async {
    ...
    if (globals.filesRef.items.length == 0) {
      globals.isFilesRefEmpty = true;
    }
    return true;
  }
                ...
                SizedBox(
                  ...
                  child: FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (globals.isFilesRefEmpty) {
                          globals.isFilesRefEmpty = false;
                          return const Center(
                            child: Text(
                              'Unavailable',
                              style: TextStyle(
                                                        ...
                                                        child: Center(
                                                          child:
                                                            ...
                                                            scrollDirection:
                                                                Axis.horizontal,
                                                            child: Text(
                                                              '${usersDetailsList[index][0]}, B-Tech ${usersDetailsList[index][1]}, ${usersDetailsList[index][2]}',
                                                              style:
                                                                  const TextStyle(
                                                                fontSize: 14,
                                                                fontWeight:
